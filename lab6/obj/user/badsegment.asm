...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	6b250513          	addi	a0,a0,1714 # 8006e8 <main+0x20>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	6b250513          	addi	a0,a0,1714 # 800708 <main+0x40>
...
exit(int error_code) {
  ...
  800128:	5ec50513          	addi	a0,a0,1516 # 800710 <main+0x48>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017e:	5ae40413          	addi	s0,s0,1454 # 800728 <main+0x60>
    }
  ...
  8001ca:	56240413          	addi	s0,s0,1378 # 800728 <main+0x60>
    putch("0123456789abcdef"[mod], putdat);
  ...
  800206:	52640413          	addi	s0,s0,1318 # 800728 <main+0x60>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800254:	50ca8a93          	addi	s5,s5,1292 # 80075c <main+0x94>
    putch("0123456789abcdef"[mod], putdat);
  800258:	00000b17          	auipc	s6,0x0
  80025c:	4d0b0b13          	addi	s6,s6,1232 # 800728 <main+0x60>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800514:	46878793          	addi	a5,a5,1128 # 800978 <error_string>
  ...
  800524:	23860613          	addi	a2,a2,568 # 800758 <main+0x90>
  ...
  800536:	21660613          	addi	a2,a2,534 # 800748 <main+0x80>
  ...
  800666:	0de40413          	addi	s0,s0,222 # 800740 <main+0x78>
            if (width > 0 && padc != '-') {
  ...
  800686:	0bf40413          	addi	s0,s0,191 # 800741 <main+0x79>
...
main(void) {
  ...
  8006ce:	37660613          	addi	a2,a2,886 # 800a40 <error_string+0xc8>
  8006d2:	45a5                	li	a1,9
  8006d4:	00000517          	auipc	a0,0x0
  8006d8:	37c50513          	addi	a0,a0,892 # 800a50 <error_string+0xd8>
main(void) {
  8006dc:	e406                	sd	ra,8(sp)
    panic("FAIL: T.T\n");
  8006de:	949ff0ef          	jal	ra,800026 <__panic>
