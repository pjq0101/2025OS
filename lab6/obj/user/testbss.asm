...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	75250513          	addi	a0,a0,1874 # 800788 <main+0xc0>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	75250513          	addi	a0,a0,1874 # 8007a8 <main+0xe0>
...
exit(int error_code) {
  ...
  800128:	68c50513          	addi	a0,a0,1676 # 8007b0 <main+0xe8>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017e:	64e40413          	addi	s0,s0,1614 # 8007c8 <main+0x100>
    }
  ...
  8001ca:	60240413          	addi	s0,s0,1538 # 8007c8 <main+0x100>
    putch("0123456789abcdef"[mod], putdat);
  ...
  800206:	5c640413          	addi	s0,s0,1478 # 8007c8 <main+0x100>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800254:	5aca8a93          	addi	s5,s5,1452 # 8007fc <main+0x134>
    putch("0123456789abcdef"[mod], putdat);
  800258:	00000b17          	auipc	s6,0x0
  80025c:	570b0b13          	addi	s6,s6,1392 # 8007c8 <main+0x100>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800514:	50878793          	addi	a5,a5,1288 # 800a18 <error_string>
  ...
  800524:	2d860613          	addi	a2,a2,728 # 8007f8 <main+0x130>
  ...
  800536:	2b660613          	addi	a2,a2,694 # 8007e8 <main+0x120>
  ...
  800666:	17e40413          	addi	s0,s0,382 # 8007e0 <main+0x118>
            if (width > 0 && padc != '-') {
  ...
  800686:	15f40413          	addi	s0,s0,351 # 8007e1 <main+0x119>
...
int
main(void) {
  8006c8:	1141                	addi	sp,sp,-16
    cprintf("Making sure bss works right...\n");
  8006ca:	00000517          	auipc	a0,0x0
  8006ce:	41650513          	addi	a0,a0,1046 # 800ae0 <error_string+0xc8>
main(void) {
  8006d2:	e406                	sd	ra,8(sp)
    cprintf("Making sure bss works right...\n");
  8006d4:	9cfff0ef          	jal	ra,8000a2 <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  8006d8:	00001597          	auipc	a1,0x1
  8006dc:	92858593          	addi	a1,a1,-1752 # 801000 <bigarray>
    cprintf("Making sure bss works right...\n");
  8006e0:	87ae                	mv	a5,a1
    for (i = 0; i < ARRAYSIZE; i ++) {
  8006e2:	4681                	li	a3,0
  8006e4:	00100637          	lui	a2,0x100
  8006e8:	a029                	j	8006f2 <main+0x2a>
  8006ea:	2685                	addiw	a3,a3,1
  8006ec:	0791                	addi	a5,a5,4
  8006ee:	00c68f63          	beq	a3,a2,80070c <main+0x44>
        if (bigarray[i] != 0) {
  8006f2:	4398                	lw	a4,0(a5)
  8006f4:	db7d                	beqz	a4,8006ea <main+0x22>
            panic("bigarray[%d] isn't cleared!\n", i);
  8006f6:	00000617          	auipc	a2,0x0
  8006fa:	40a60613          	addi	a2,a2,1034 # 800b00 <error_string+0xe8>
  8006fe:	45b9                	li	a1,14
  800700:	00000517          	auipc	a0,0x0
  800704:	42050513          	addi	a0,a0,1056 # 800b20 <error_string+0x108>
  800708:	91fff0ef          	jal	ra,800026 <__panic>
  80070c:	00001717          	auipc	a4,0x1
  800710:	8f470713          	addi	a4,a4,-1804 # 801000 <bigarray>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  800714:	4781                	li	a5,0
  800716:	001006b7          	lui	a3,0x100
        bigarray[i] = i;
  80071a:	c31c                	sw	a5,0(a4)
    for (i = 0; i < ARRAYSIZE; i ++) {
  80071c:	2785                	addiw	a5,a5,1
  80071e:	0711                	addi	a4,a4,4
  800720:	fed79de3          	bne	a5,a3,80071a <main+0x52>
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  800724:	4681                	li	a3,0
  800726:	00100737          	lui	a4,0x100
  80072a:	a029                	j	800734 <main+0x6c>
  80072c:	2685                	addiw	a3,a3,1
  80072e:	0591                	addi	a1,a1,4
  800730:	02e68063          	beq	a3,a4,800750 <main+0x88>
        if (bigarray[i] != i) {
  800734:	419c                	lw	a5,0(a1)
  800736:	fed78be3          	beq	a5,a3,80072c <main+0x64>
            panic("bigarray[%d] didn't hold its value!\n", i);
  80073a:	00000617          	auipc	a2,0x0
  80073e:	3f660613          	addi	a2,a2,1014 # 800b30 <error_string+0x118>
  800742:	45d9                	li	a1,22
  800744:	00000517          	auipc	a0,0x0
  800748:	3dc50513          	addi	a0,a0,988 # 800b20 <error_string+0x108>
  ...
  800754:	40850513          	addi	a0,a0,1032 # 800b58 <error_string+0x140>
  800758:	94bff0ef          	jal	ra,8000a2 <cprintf>
    cprintf("testbss may pass.\n");
  80075c:	00000517          	auipc	a0,0x0
  800760:	43450513          	addi	a0,a0,1076 # 800b90 <error_string+0x178>
  800764:	93fff0ef          	jal	ra,8000a2 <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
    // asm volatile ("int $0x14");
    panic("FAIL: T.T\n");
  800768:	00000617          	auipc	a2,0x0
  80076c:	44060613          	addi	a2,a2,1088 # 800ba8 <error_string+0x190>
  800770:	45fd                	li	a1,31
  800772:	00000517          	auipc	a0,0x0
  800776:	3ae50513          	addi	a0,a0,942 # 800b20 <error_string+0x108>
    bigarray[ARRAYSIZE + 1024] = 0;
  80077a:	00402797          	auipc	a5,0x402
  80077e:	8807a323          	sw	zero,-1914(a5) # c02000 <bigarray+0x401000>
    panic("FAIL: T.T\n");
