...
exit(int error_code) {
  ...
  8000ce:	5d650513          	addi	a0,a0,1494 # 8006a0 <main+0x2e>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800128:	59440413          	addi	s0,s0,1428 # 8006b8 <main+0x46>
    }
  ...
  800174:	54840413          	addi	s0,s0,1352 # 8006b8 <main+0x46>
    putch("0123456789abcdef"[mod], putdat);
  ...
  8001b0:	50c40413          	addi	s0,s0,1292 # 8006b8 <main+0x46>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001fe:	4f2a8a93          	addi	s5,s5,1266 # 8006ec <main+0x7a>
    putch("0123456789abcdef"[mod], putdat);
  800202:	00000b17          	auipc	s6,0x0
  800206:	4b6b0b13          	addi	s6,s6,1206 # 8006b8 <main+0x46>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8004be:	44e78793          	addi	a5,a5,1102 # 800908 <error_string>
  ...
  8004ce:	21e60613          	addi	a2,a2,542 # 8006e8 <main+0x76>
  ...
  8004e0:	1fc60613          	addi	a2,a2,508 # 8006d8 <main+0x66>
  ...
  800610:	0c440413          	addi	s0,s0,196 # 8006d0 <main+0x5e>
            if (width > 0 && padc != '-') {
  ...
  800630:	0a540413          	addi	s0,s0,165 # 8006d1 <main+0x5f>
...
main(void) {
  ...
  800674:	e406                	sd	ra,8(sp)
    cprintf("I am %d, print pgdir.\n", getpid());
  800676:	a63ff0ef          	jal	ra,8000d8 <getpid>
  80067a:	85aa                	mv	a1,a0
  80067c:	00000517          	auipc	a0,0x0
  800680:	35450513          	addi	a0,a0,852 # 8009d0 <error_string+0xc8>
  800684:	9bdff0ef          	jal	ra,800040 <cprintf>
    print_pgdir();
  800688:	a53ff0ef          	jal	ra,8000da <print_pgdir>
    cprintf("pgdir pass.\n");
  80068c:	00000517          	auipc	a0,0x0
  800690:	35c50513          	addi	a0,a0,860 # 8009e8 <error_string+0xe0>
  800694:	9adff0ef          	jal	ra,800040 <cprintf>
    return 0;
}
  800698:	60a2                	ld	ra,8(sp)
  80069a:	4501                	li	a0,0
  80069c:	0141                	addi	sp,sp,16
  80069e:	8082                	ret
