...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	6c250513          	addi	a0,a0,1730 # 8006f8 <main+0x30>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	6c250513          	addi	a0,a0,1730 # 800718 <main+0x50>
...
exit(int error_code) {
  ...
  800128:	5fc50513          	addi	a0,a0,1532 # 800720 <main+0x58>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017e:	5be40413          	addi	s0,s0,1470 # 800738 <main+0x70>
    }
  ...
  8001ca:	57240413          	addi	s0,s0,1394 # 800738 <main+0x70>
    putch("0123456789abcdef"[mod], putdat);
  ...
  800206:	53640413          	addi	s0,s0,1334 # 800738 <main+0x70>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800254:	51ca8a93          	addi	s5,s5,1308 # 80076c <main+0xa4>
    putch("0123456789abcdef"[mod], putdat);
  800258:	00000b17          	auipc	s6,0x0
  80025c:	4e0b0b13          	addi	s6,s6,1248 # 800738 <main+0x70>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800514:	47878793          	addi	a5,a5,1144 # 800988 <error_string>
  ...
  800524:	24860613          	addi	a2,a2,584 # 800768 <main+0xa0>
  ...
  800536:	22660613          	addi	a2,a2,550 # 800758 <main+0x90>
  ...
  800666:	0ee40413          	addi	s0,s0,238 # 800750 <main+0x88>
            if (width > 0 && padc != '-') {
  ...
  800686:	0cf40413          	addi	s0,s0,207 # 800751 <main+0x89>
...
main(void) {
  ...
  8006c8:	3eb00793          	li	a5,1003
  8006cc:	07da                	slli	a5,a5,0x16
  8006ce:	438c                	lw	a1,0(a5)
main(void) {
  8006d0:	1141                	addi	sp,sp,-16
    cprintf("I read %08x from 0xfac00000!\n", *(unsigned *)0xfac00000);
  8006d2:	00000517          	auipc	a0,0x0
  8006d6:	37e50513          	addi	a0,a0,894 # 800a50 <error_string+0xc8>
main(void) {
  ...
  8006e4:	39060613          	addi	a2,a2,912 # 800a70 <error_string+0xe8>
  8006e8:	459d                	li	a1,7
  8006ea:	00000517          	auipc	a0,0x0
  8006ee:	39650513          	addi	a0,a0,918 # 800a80 <error_string+0xf8>
  8006f2:	935ff0ef          	jal	ra,800026 <__panic>
